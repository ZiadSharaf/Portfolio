...
const projectData = [
    {
        ...
        description: "Cleaned and analyzed a car sales dataset containing 30 manufacturers and 157 models. Predicted missing values using machine learning in Python and built interactive dashboards using Excel to uncover insights for stakeholders.Technologies used: Python, scikit-learn, Excel (Power Query, Power Pivot, DAX)",
        github: "https://github.com/ZiadSharaf/Car-Sales-Project",
        media: ["MainDashboard.png","Performance1Dashboard.png","Performance2Dashboard.png", "Car_Sales_Project_Dashboard_Video.mp4"]
    },
        ...
        btn.addEventListener("click", (e) => {
            ...
            project.media.forEach((item) => {
                ...
                if (item.endsWith(".mp4")) {
                    mediaElement = `<video src="${item}" controls></video>`;
                } else {
                    mediaElement = `<img src="${item}" alt="">`;
                }
